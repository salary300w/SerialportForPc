...
//打开串口
void Widget::openport_button_clicked()
{
   update();
   sleep(100);      //延时100ms
   find_port();     //重新查找com
...
//关闭串口
void Widget::closeport_button_clicked()
{
...
void Widget::clear_button_1_clicked()
{
    ui->send_text_window->clear();
}

void Widget::clear_button2_clicked()
{
    ui->Receive_text_window->clear();
}

//接收框文本模式转换
void Widget::receive_modl_clicked()
{
...
void Widget::paintEvent(QPaintEvent *)
{
    QPainter pen(this);
    //设置显示背景
    QPixmap showbackground;
    showbackground.load(":/img/chengse.png");
    pen.drawPixmap(0,0,this->width(),this->height(),showbackground);
...
void Widget::sendcoordinate_button_clicked()
{
